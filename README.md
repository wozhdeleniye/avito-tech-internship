...
2. Добавил e2e тестирование. Для запуска тестирования необходимо в корне проекта выполнить команду ```powershell go test ./e2e -v```. Тестирование проводится независимо от самого приложения, так что указанный внутри порт может устареть при изменениях.
